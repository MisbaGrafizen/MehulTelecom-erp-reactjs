const PurchaseModalCash = ({ transaction, onClose }) => {
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                <p className="text-gray-600">PO No</p>
                <p className="font-medium text-gray-900">{transaction.details.poNo}</p>
              </div>
              <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              {[...Array(transaction.details.itemCount)].map((_, i) => (
                <div key={i} className="flex justify-between py-2">
                  ...
                  <span className="text-gray-900">1 × ₹8,000</span>
                </div>
              ))}
            </div>
          </div>
...
export default PurchaseModalCash;
