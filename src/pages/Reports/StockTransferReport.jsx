      ...
      <div className="flex items-start justify-between relative z-10">
        <div className="flex-1">
          ...
          <div className="flex items-baseline gap-3">
            <h3 className="text-3xl md:text-4xl font-[600]" style={{ color: bgColor }}>
            ...
            {trend && (
              <motion.span
                ...
                className={`text-xs font-[600] flex items-center gap-1 px-2 py-1 rounded-full ${trend > 0
...
const TransferTable = ({ data, onViewTransfer, currentPage, setCurrentPage, itemsPerPage }) => {
  ...
  const getStatusBadgeClass = (status) => {
    ...
    return badges[status] || "bg-gray-100 text-foreground"
  }
    ...
    >
      <div className="overflow-x-auto">
        <table className="w-full">
          <thead>
            <tr className="border-b border-border  bg-gray-200 to-green-paid/10">
              <th className="px-6 py-4 text-left text-xs font-[600] text-foreground uppercase tracking-wide">
                Date
              </th>
              <th className="px-6 py-4 text-left text-xs font-[600] text-foreground uppercase tracking-wide">
                Transfer No.
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-gray-50 border border-border rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl"
      >


        <div className="sticky top-0 flex items-center justify-between p-2 border-b border-border  bg-white">
          <div className="flex-1">
            <h2 className="text-2xl font-[600] text-foreground mb-2">{transfer.transferNo}</h2>
            <div className="flex gap-2 flex-wrap">
              <span className="inline-block px-3 py-1 rounded-full text-xs font-medium bg-green-200 text-blue-unpaid">
                Transfer
              </span>
              <span className={`inline-block px-3 bg-blue-200 py-1 rounded-full text-xs font-medium ${transfer.status === 'completed' ? 'bg-green-light text-green-paid' :
                transfer.status === 'pending' ? 'bg-blue-200 ' :
                  'bg-gray-200 '
                }`}>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <motion.div
              ...
              className="bg-gray-100 border border-border rounded-xl p-6 space-y-4"
            >
              <h3 className="font-[600] text-foreground flex items-center gap-2">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-[600] text-primary text-base">{transfer.items}</span>
                </div>
                <div className="flex justify-between text-sm pt-2 border-t border-border">
                  <span className="text-muted-foreground">Total Value</span>
                  <span className="font-[600] text-green-paid text-base">{transfer.total}</span>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-gray-100 border border-border rounded-xl p-6 space-y-4"
            >
              <h3 className="font-[600] text-foreground">Company & Branch</h3>
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex gap-3 flex-1">
                      <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-pink-600 to-blue-600 flex items-center justify-center flex-shrink-0">
                    ...
                    <span className="px-3 py-1 rounded-full bg-purple-100 text-purple-700 text-xs font-[600] flex-shrink-0">
                      Qty: {item.qty}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-border">
                    ...
                    <div className="text-sm text-right">
                      ...
                      <p className="font-[600] text-green-paid text-base">{item.total}</p>
                    </div>
                  </div>
                </motion.div>
              ))}
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-2xl font-[600] text-green-paid">{transfer.items}</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm font-[600] text-blue-unpaid text-center">{transfer.from}</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-lg font-[600] text-orange-total">{transfer.total}</p>
            </motion.div>
          </div>
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.4 }}
            className="flex items-center justify-between p-4 bg-gray-100 border border-border rounded-xl"
          >
                  ...
                  >
                    <div className="">
                      ...
                      <div className=" flex justify-between ">
                        ...
                        <div className="flex  gap-4 w-[500px] flex-col sm:flex-row">


                          <div className="flex w-[100%] items-center gap-2 bg-input border border-border rounded-lg px-4 py-2">
